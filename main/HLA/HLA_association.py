...
class HLAanalysis:
    def __init__(
            self, hla_filename, assoc_filename, pheno_file, covar_file, confusion_folder, output_file, digits=4,
            covar_col=""
    ):
        ...
        self.associations = [l.strip() for l in open(assoc_filename, "r")]
    ...
    def read_and_reformat_hla(self, hlafile):
        ...
        hla = pd.read_excel(hlafile, dtype='object', index_col=0)
